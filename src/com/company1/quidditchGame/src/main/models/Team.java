package com.company1.quidditchGame.src.main.models;
...
public class Team {
    ...
    static public boolean hasNull(String[] array){
        return Arrays.stream(array).anyMatch((chaser) -> chaser == null);
//         for (int i = 0; i < array.length; i++) {
//             if (array[i] == null) return true;
//         }return false;
    }

    static public boolean hasBlank(String[] array){
        return Arrays.stream(array).anyMatch((chaser) -> chaser.isBlank());
//         for (int i = 0; i < array.length; i++) {
//             if (array[i].isBlank())return true;
//         }return false;
    }
