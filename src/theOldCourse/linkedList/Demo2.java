...
public class Demo2 {
    public static void main(String[] args) {
        ...
        addInOrder(placesToVisit, "B");
        addInOrder(placesToVisit, "C");
        addInOrder(placesToVisit, "D");
        addInOrder(placesToVisit, "E");
        addInOrder(placesToVisit, "F");
        addInOrder(placesToVisit, "J");
        printList(placesToVisit);

        addInOrder(placesToVisit, "H");
        addInOrder(placesToVisit, "I");
        printList(placesToVisit);
        visit(placesToVisit);
    }
